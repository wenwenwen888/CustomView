package com.kingcheergame.customview.view1_6.practice.practice08;
...
public class Practice08ObjectAnimatorView extends View {
    final float radius = PxDpUtil.dip2px(getContext(), 80);
    ...
    {
        paint.setTextSize(PxDpUtil.dip2px(getContext(), 40));
    ...
    public void onDraw(Canvas canvas) {
        ...
        paint.setStrokeWidth(PxDpUtil.dip2px(getContext(), 15));
