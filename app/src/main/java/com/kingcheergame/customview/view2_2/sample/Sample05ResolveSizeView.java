...
public class Sample05ResolveSizeView extends PM25View {
    private static final String TAG = "HenCoder ResolveSize";

    public Sample05ResolveSizeView(Context context) {
        super(context);
    }

    public Sample05ResolveSizeView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Sample05ResolveSizeView(Context context, AttributeSet attrs, int defStyleAttr) {
