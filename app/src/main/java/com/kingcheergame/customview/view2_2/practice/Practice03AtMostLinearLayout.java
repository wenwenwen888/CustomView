...
public class Practice03AtMostLinearLayout extends LinearLayout {

    private boolean isHideCenter = false;
    Button leftButton, centerButton;

    public Practice03AtMostLinearLayout(Context context) {
        super(context);
    }

    public Practice03AtMostLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public Practice03AtMostLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
