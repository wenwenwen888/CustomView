package com.kingcheergame.customview.common;
...
public class Common01AdjustablePanel extends RelativeLayout {
    ...
    float bottomMargin = dip2px(getContext(),48);
    float minWidth = dip2px(getContext(),80);
    float minHeight = dip2px(getContext(),100);
